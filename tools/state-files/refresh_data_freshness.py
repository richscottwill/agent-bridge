...
KNOWN_SOURCES = {
    ...
    "hedy_meetings": {"type": "deprecated", "cadence_hours": 9999,
                      "workflows": ["DEPRECATED 2026-05-06 — replaced by topic-log markdown files under ~/shared/wiki/topics/"]},
    "topic_logs": {"type": "file_count", "cadence_hours": 24,
                   "workflows": ["meeting_sync_v2", "topic_log_ingest"],
                   "path_glob": "~/shared/wiki/topics/**/*.md"},
