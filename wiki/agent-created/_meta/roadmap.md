...
Last updated: 2026-05-01 (wiki-maintenance W18 second pass — polaris-program MX NB LP subsection shipped)
...
| **MX CCP methodology + Sparkle annotations** | markets/mx-market-wiki, strategy/ieccp-planning-framework | **P1** | W18 — 9 signals from 4/22 projection session | Canonical CCP values (Brand $90 / NB $30), correct ie%CCP formula (per-reg weighting, not blended), Brand-anchor / NB-residual architecture, H1-H2 2025 regime shift, Sparkle decay methodology. Needs both articles updated in one pass. |
