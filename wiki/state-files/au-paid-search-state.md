...
Last week's W18 forecast of 228 regs (CI 195–308) scored HIT — actual 228 fell inside CI with 0% error. AU calibration remains stable at 65% hit rate on 20 scored predictions.
<!-- WBR-OWNED:prediction-scoring END -->

<!-- WBR-OWNED:forecast START -->
**W19 forecast (Bayesian seasonal brand/NB split, forecast date 2026-05-05):** 252 registrations (CI 212–318), $31.7K spend, $126 CPA. Assumes post-Anzac Day normalization with Brand CPA holding the $31–33 YTD floor and NB CVR returning to the 2.5–3.0% range. If actual W19 regs fall below CI low of 212, the post-Anzac softening hypothesis upgrades from candidate to confirmed Q2 demand pattern warranting settings review before W20.
...
- AU handoff locked 5/5 with Brandon (project_timeline AU_handoff decision, 2026-04-21) — biweekly cadence, no scheduled AU calls after handoff. This is the final WBR callout authored in the current ownership model.
- Brandon asked for Kiro weekly AU change aggregator before 5/5 handoff (project_timeline AU_handoff commitment, 2026-04-21) — post-handoff oversight mechanism is an open deliverable.
- Third AU operational reliability lapse in two weeks (project_timeline AU escalation, 2026-04-21, Brandon 6:32am live-escalation on Alexis biweekly call calendar confusion). Reliability pattern is not callout-derived but is the operational context for this handoff week.
