...
3. Expand OCI to remaining markets — CA launch on April 7, AU target May 2026, MX timeline TBD — achieving 100% coverage of active markets by Q4 2026.
...
| Workstream | Test | Market | Result | Confidence | Status |
|---|---|---|---|---|---|
| OCI Bidding | Smart Bidding w/ OCI signal | US | +24% regs, $16.7MM OPS | High | Scaled |
| OCI Bidding | Smart Bidding w/ OCI signal | UK | +23% regs | High | Scaled |
| OCI Bidding | Smart Bidding w/ OCI signal | DE | +18% regs | High | Scaled |
| Modern Search | Ad Copy Phase 1 | UK | +86% CTR, +31% regs | High | Complete |
| Modern Search | Ad Copy Phase 1 | IT | Inconclusive | Low | Needs larger sample |
| Audiences | Engagement Channel | US | $765K iOPS | High | Validated |
| Audiences | Prime Day 2025 | US | $329K OPS, 644% ROAS | High | Event complete |
...
| `{{APPENDIX_D_TESTS}}` | Appendix D — workstream test results | Testing wiki articles | On change |
...
Static sections (Goals, Tenets, Appendix B OCI status, Appendix D test results) are NOT in the JSON — they persist unchanged in the template until manually revised or a test status changes.
