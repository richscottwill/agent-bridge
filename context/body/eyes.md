...
*Operating principle: Structural over cosmetic. Eyes doesn't just report numbers

Last updated: 2026-04-02
Sources: WBR callouts, MBR/QBR data, Google Ads, competitor monitoring, ad copy tests, W13 dashboard data, Slack ingestion

---


### MCC Structure
- Master MCC: DSAP - Amazon Business Parent MCC
- NA MCC: 683-476-0964
- EU MCC: 549-849-5609
- JP MCC: 852-899-4580
- AU: Not created

**Worked example — reading OCI status for meeting prep:** CA shows 🟡 On track with E2E launched 3/4 and full impact Jul 2026. In a WBR, lead with "CA OCI on track for Apr dial-up, full impact expected Jul 2026"
...
- _Predicted questions cleared at EOD 4/3.
- Regenerated each AM-2 from calendar + active threads + Slack signals._.

*Example:* When this applies, the expected outcome is verified by checking the result.
### US: Walmart Business
- Brand Core since Jul 2024.
- IS: 25%→55%.
- Brand CPA impact: ~$40→$65-77.
- Seasonal: ramps Jan-Mar, pulls back holidays.
- Response: bid caps + NB OCI efficiency.
- Only sustained US Brand bidder.
...
- Phase 2: All NB
- Phase 3: Brand Plus
- EU4 translations completed via GlobalLink

---


[38;5;10m> [0m### OCI Status by Market (as of 4/2)[0m[0m
| Market | Status | Launch/Target | Detail |[0m[0m
|--------|--------|---------------|--------|[0m[0m
| US | ✅ Live | 2025 | Baseline market. Peak Jan: 39K regs (+86% YoY). |[0m[0m
| UK | ✅ Live | E2E launched | Ad copy Phase 1 running: +86% CTR, +31% regs. |[0m[0m
| DE | ✅ Live | E2E launched | +16-20% lift (W49-W51). Data loss 3/18-3/25 — verify backfill. |[0m[0m
| FR | ✅ Live | 3/30 dial-up | 775 clicks confirmed 3/24 UTC. Monitor ramp. |[0m[0m
| IT | ✅ Live | 3/30 dial-up | 1,412 clicks. Ad copy: +15% CTR but LOW volume — needs longer window. |[0m[0m
| ES | ✅ Live | 3/30 dial-up | 1,168 clicks confirmed 3/24 UTC. Monitor ramp. |[0m[0m
| JP | ✅ Live | 3/31 dial-up | MCM-147368188 COMPLETE. Watch Yahoo competitor IS growth. |[0m[0m
| CA | 🟡 On track | Target 04/07 | E2E launched 3/4. Full impact expected Jul 2026. Next milestone: Apr dial-up. |[0m[0m
| AU | 🔴 Not started | TBD | No MCC created — blocked until MCC setup. |[0m[0m
| MX | 🔴 Not started | TBD | No MCC created — blocked until MCC setup. |[0m[0m
[0m[0m
**Rollout: 7/10 live (70%).** Next: CA (Apr). AU/MX: TBD.[0m[0m
[0m[0m
**Example — Reading the lifecycle of a market launch (UK):** UK moved through three stages: (1) MCC creation and E2E technical launch, (2) ad copy Phase 1 test where creative variants were A/B tested against controls, and (3) performance validation showing +86% CTR and +31% registrations vs. the prior setup. A market like CA is currently between stages 1 and 2 — E2E launched on 3/4 but still ramping toward full dial-up in April, with measurable impact not expected until Jul 2026. AU and MX, by contrast, are blocked at stage 0: no MCC has been created yet, so no technical work can begin.[0m[0m
[0m[0m
**Common failure:** Misinterpreting the scope of this section
...
- shop-pro.jp emerging with 12-15% IS.
- Intensifying since MHLW campaign ended 1/31.
- Monitor for further IS growth.

**Worked example:** Walmart IS surged to 55% in W6 2026. Instead of increasing Brand bids to reclaim IS, we held bid caps and shifted budget to NB OCI. Result: Brand CPA stabilized at $65-77 without auction escalation, NB efficiency improved via OCI.
...
- +15% CTR directionally, but volume too low
- Confidence: LOW


### Market Deep Dives

**Reading this table:** Each row is one market's latest snapshot. "vs OP2" means performance against the annual operating plan. "Key Signal" is the single most important development
