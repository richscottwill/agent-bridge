...
Richard Williams | L5 Marketing Manager | Amazon Business Paid Search | Manager: Brandon Munday (L7, she/her) | Skip: Kate Rundell (L8 Director) | VP: Todd Heimes (L10) | Seattle, SEA28 | Hired Nov 2023
...
### Active Projects & Market Performance (as of 4/3/26)

| # | Project | Status | Level | Priority | Market Performance (Feb 2026) |
|---|---------|--------|-------|----------|-------------------------------|
| 1 | Testing Approach doc for Kate | NOT STARTED — 14 workdays. Apr 16 canceled, doc still needed. | L1/L2 | 🔴 L1 gate blocker | — |
| 6 | MX Auto/Beauty pages | OVERDUE (15d) — blocked by Vijeth footer | L2 | 🔴 Overdue | MX: 1.1K regs (+32% OP2, +37% YoY), $68K |
| 3 | AU CPC/Keyword Optimization | Lena follow-up pending (3d) | L2 | 🟡 Pending response | AU: 1.1K regs (-1% OP2), $159K, ~$140 CPA target |
| 4 | OCI ROW rollout | 7/10 at 100%, CA 4/7 | L2 | 🟢 On track | CA: 2.8K regs (+18.5% OP2), $207K, $73 CPA |
| 2 | Polaris Brand LP WW Rollout | weblab 4/6-7 | L2 | 🟢 On track | US: 32.9K regs (+16% OP2, +68% YoY), $2.7M, $83 CPA |
| 5 | Ad copy testing | UK +86% CTR, IT low volume | L2 | 🟢 On track | — |
...
### Team
See `roster.md` for full team directory (Brandon's directs, levels, focus areas, locations).
...
- Measure holistically (total program CPA, not Brand vs NB in isolation)
- Phase all rollouts with measurement (OCI playbook: 50/50 split → measure → scale)
...
- AU LP: full Polaris switch confirmed by Lena — executing, no phased option
- AU CPC: B2B CPA inherently higher than consumer; Shopping Ads unavailable for AB; OCI is the lever
...
- Respond to competitive pressure with efficiency, not budget (Walmart IS 25%→55% drove Brand CPA $40→$65-77 — countered with bid caps + OCI, not spend increase)
...
### Key Quip Docs
- MX Sync: quip-amazon.com/K9OYA9mXm7DU
- Pre-WBR Callouts: quip-amazon.com/MMgBAzDrlVou
- OCI Instructions: quip-amazon.com/Zee9AAlSBEB
- Ad Copy Updates: quip-amazon.com/KCY9AAYqWd2
- Testing Plan 2026: quip-amazon.com/EED9AAFOy4E
...
**Quick Reference (by last interaction):**
| Name | Alias | Last | Role |
|------|-------|------|------|
| Kate Rundell | kataxt | 4/3 | L8 Director, skip-level |
| Megan Lim | megalim | 4/3 | EA to Kate |
| Brandon Munday | brandoxy | 4/2 | L7 Manager (she/her) |
| Lena Zak | lenazak | 4/1 | L7 AU Country Leader |
| Frank Volinsky | — | 3/31 | MCS team |
| Caroline Miller | carolimy | 3/27 | Product Marketing |
| Vijay Kumar | vkumarmp | 3/26 | Tech Lead, Baloo |
| Lorena Alvarez Larrea | lorealea | 3/25 | MX L5 |
| Adi Thakur | — | 3/25 | L5 peer |
| Alexis Eck | alexieck | 3/24 | AU L6 |
...
- Meeting dynamic: Runs the biweekly onsite events sync. Expects pre-reads. Tracks deadlines closely — always have dates ready. Coordinates with Dwayne on event logistics.
...
- Last interaction: 3/25 (Adi sync — AI ad-copy workflow JP, 43 min)
- Tone/Draft: Casual, peer-level
- Topics: AI ad-copy (JP 15-char limit, D-Pel vs AI), Paid Acq Testing workspace, LP UX OP1
- Dynamic: Richard mentors Adi on pacing, ICCP, analytical frameworks. Adi growing (70-80% → active contributor). Richard most articulate here — capture teaching moments as frameworks.
...
### Cross-Cutting Dynamics - **AU chain of command:** Lena (L7, strategy) → Alexis (L6, execution) → Richard (PS perspective). Lena overrides phased approaches — always have AU CPA data loaded before any AU interaction. - **MX transition:** Carlos (CPS, departed) → Lorena (PS, as of 3/17). Professional register — newer relationship, not casual. - **Group visibility gap:** Richard ~40% share in 1:1s (healthy) but <15% in groups. Andrew dominates. Counter: prepare strategic commentary before group meetings, speak during Andrew's EU updates. - **Brandon alignment:** Most active channel. She/her. Supports Richard owning AU narrative. Flagged Lena's decision-reversal pattern explicitly in 4/2 1:1. --- 
...
## Usage Guide — Meeting Prep & Common Failures

**Meeting Prep:** Series files live in `~/shared/wiki/meetings/` — one file per recurring series.

| Subfolder | Covers |
|-----------|--------|
| `meetings/stakeholder/` | AU, MX, Google, Adobe, MCS/Polaris, OCI |
| `meetings/team/` | Weekly sync, deep dive, promo OHs, PAM, activation |
| `meetings/manager/brandon-sync.md` | Brandon 1:1 |
| `meetings/peer/` | Adi, Yun, Andrew |
| `meetings/adhoc/adhoc-log.md` | One-off meetings |

Each series file contains metadata, context, latest session summary, running themes, and open items. Use the relationship graph for tone/draft style; use series files for meeting-specific dynamics, decisions, and action items.

**Common Failures:**
1. **Pronoun error on Brandon.** Brandon uses she/her pronouns — zero tolerance for error. Before any draft mentioning Brandon: check relationship graph → confirm she/her → write. Worked example: "She mentioned in our 1:1 that the Testing Approach needs revision" — never "he" or "they."
2. **Register mismatch.** Match tone to relationship depth. Established contacts (e.g., Lena): lead with data — "AU CPA is $140 — here's the plan." Newer contacts (e.g., Lorena): warm opener first — "Hi Lorena, I wanted to share the latest on AU CPA performance." Always read the relationship graph entry before drafting.
3. **Carlos ≠ Lorena on MX.** MX PS stakeholder changed on 3/17. Carlos moved to CPS. Lorena is now the PS stakeholder. Never conflate them — they hold different roles in different orgs.
4. **Stale interaction dates.** If last interaction exceeds 14 days, dynamics may have shifted. Check the Relationship Staleness Index before drafting. Worked example: Yun-Kang (last interaction 3/19, 17d stale) → flag "Low risk but stale" → open with a brief check-in before making the ask.
...
| Doc | Link | Use | Frequency | Owner |
|-----|------|-----|-----------|-------|
| Pre-WBR Callouts | [quip](https://quip-amazon.com/MMgBAzDrlVou) | Draft callouts before WBR | Weekly | Richard (AU/MX sections) |
| MX PS Sync | [quip](https://quip-amazon.com/K9OYA9mXm7DU) | MX weekly sync notes (Lorena) | Weekly | Richard + Lorena |
| Paid Acq Projects | [quip](https://quip-amazon.com/bXT9AA5YdtN) | Project tracker | As needed | Team-wide |
| PO Process Options | [quip](https://quip-amazon.com/NXF9AAy02OQ) | Invoice/PO reference | Monthly | Finance coordination |
| Holiday Tracker | [quip](https://quip-amazon.com/dGM9AARtQnG) | Market holiday calendar | Seasonal | Team-wide |

**Sub-folders (by doc count):**
| Folder | Link |
|--------|------|
| Testing (20) | [quip](https://quip-amazon.com/NfR9OA6clcH/) |
| Review (15) | [quip](https://quip-amazon.com/MRQ9OA8fzMn/) |
| EU (8) | [quip](https://quip-amazon.com/aXF9OAXXhSH/) |
| Events (5) | [quip](https://quip-amazon.com/Afc9OA7yLSI/) |
| JP (5) | [quip](https://quip-amazon.com/Xca9OAoab2S/) |
| Planning (4) | [quip](https://quip-amazon.com/QcL9OAla0aR/) |
| Onboarding (4) | [quip](https://quip-amazon.com/JeH9OAHbCkF/) |
| ABIX (2) | [quip](https://quip-amazon.com/dOP9OAN9Quw/) |
| NA | [quip](https://quip-amazon.com/JTP9OAfqvcL/) |
