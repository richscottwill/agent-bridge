...
| 6 | MX Auto/Beauty pages | OVERDUE (15d) — blocked by Vijeth footer | L2 | 🔴 Overdue |
| 3 | AU CPC/Keyword Optimization | Lena follow-up pending (3d) | L2 | 🟡 Pending response |
| 4 | OCI ROW rollout | 7/10 at 100%, CA 4/7 | L2 | 🟢 On track |
| 2 | Polaris Brand LP WW Rollout | weblab 4/6-7 | L2 | 🟢 On track |
...
- AU LP: Lena confirmed full Polaris switch — executing
- AU CPC: B2B inherently higher than consumer; Shopping Ads not available for AB; OCI will help
- Efficiency over escalation as competitive response (applied: Walmart IS 25%→55% drove Brand CPA $40→$65-77 — responded with bid caps + OCI, not budget increase)
...
Contacts with last interaction >14 days. Check before drafting — dynamics may have shifted.

| Contact | Last Interaction | Days Stale | Risk |
|---------|-----------------|------------|------|
| Yun-Kang Chu | 3/19 | 17d | Low — reliable peer, data-on-demand |
| Carlos Palmos | 3/24 | 12d | N/A — transitioned to CPS |
| Harjeet Heer | 3/11 | 25d | Low — stepped away from AU |
...
1. **Missing pronoun check.** Brandon uses she/her. Identity fields are non-negotiable. Always verify before drafting.
2. **Wrong register for recipient.** Drafting Lena-style directness to Lorena (new relationship = professional, thorough). Always check the relationship graph entry before drafting. Example: Lena gets "AU CPA is $140 — here's the plan" (direct). Lorena gets "Hi Lorena, I wanted to share the latest on AU CPA performance and next steps" (professional, warm).
3. **Confusing Carlos (transitioned) with Lorena (current).** MX PS stakeholder changed 3/17. Carlos = CPS now. Lorena = PS.
4. **Stale interaction dates.** Using "Last interaction: 3/24" context when it's weeks later. Flag if last interaction > 14 days — the dynamic may have shifted.
...
- Team meetings: `meetings/team/` (weekly sync, deep dive, promo OHs, PAM, activation)
- Brandon 1:1: `meetings/manager/brandon-sync.md`
- Peer 1:1s: `meetings/peer/` (Adi, Yun, Andrew)
- Ad-hoc: `meetings/adhoc/adhoc-log.md`

Each series file has: metadata, context, latest session summary, running themes, and open items.
The relationship graph above still holds tone/draft style for each person — use it for communications.
The series files hold meeting-specific dynamics, decisions, and action items.
...
**Top-Level Docs:**
- [Paid Acq Projects](https://quip-amazon.com/bXT9AA5YdtN) — active project tracker
- [PO Process Options - Paid Search](https://quip-amazon.com/NXF9AAy02OQ) — PO/invoicing process
- [Outbound Holiday Tracker](https://quip-amazon.com/dGM9AARtQnG)

**Subfolders:** [Testing](https://quip-amazon.com/NfR9OA6clcH/) (20 items), [Review](https://quip-amazon.com/MRQ9OA8fzMn/) (15 items), [Planning](https://quip-amazon.com/QcL9OAla0aR/) (4 items), [Onboarding](https://quip-amazon.com/JeH9OAHbCkF/) (4 items), [Events](https://quip-amazon.com/Afc9OA7yLSI/) (5 items), [NA](https://quip-amazon.com/JTP9OAfqvcL/), [EU](https://quip-amazon.com/aXF9OAXXhSH/) (8 items), [JP](https://quip-amazon.com/Xca9OAoab2S/) (5 items), [ABIX](https://quip-amazon.com/dOP9OAN9Quw/) (2 items)

**Sync Docs:**
- [AB MX Paid Search Sync](https://quip-amazon.com/K9OYA9mXm7DU)
