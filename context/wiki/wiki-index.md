...
- [The Body System — Architecture](~/shared/artifacts/strategy/2026-03-25-body-system-architecture.md): Architecture for personal AI operating systems
  - slug: body-system-architecture | status: DRAFT | audience: personal | level: 5

- [Agentic Marketing — Industry Landscape](~/shared/artifacts/strategy/2026-03-25-agentic-marketing-landscape.md): Industry landscape and Amazon context for agentic marketing
...
- [Campaign Link Generator Spec](~/shared/artifacts/tools/2026-03-25-campaign-link-generator-spec.md): Tool spec for campaign link generator
...
- [Google Ads Campaign Structure Standards](~/shared/artifacts/best-practices/2026-03-25-google-ads-campaign-structure.md): Campaign structure standards for AB PS
  - slug: google-ads-campaign-structure | status: DRAFT | audience: amazon-internal | level: N/A

- [Landing Page Testing Playbook](~/shared/artifacts/best-practices/2026-03-25-landing-page-testing-playbook.md): LP testing playbook
  - slug: landing-page-testing-playbook | status: DRAFT | audience: amazon-internal | level: N/A

- [Invoice & PO Process Guide](~/shared/artifacts/best-practices/2026-03-25-invoice-po-process-guide.md): Invoice and PO process guide for AB PS
