...
Created: 2026-03-20
Status: Active — persistent across all sessions

## The Five Levels

These are sequential, each building on the last. They define the arc of Richard's work with the Trainer system.
...
- This is the biggest near-term unlock for the org
...
- Position PS team as forward-looking, not just channel executors
...
- Quarter-level initiative minimum
- Key metric: a PS workflow that runs end-to-end without human intervention

## Guiding Principle
Each level funds the next. Don't skip ahead. Consistency at Level 1 earns the right to drive at Level 2. Driving WW tests at Level 2 builds the operational credibility for Level 3. Adoption at Level 3 earns credibility for Level 4. Level 4 vision justifies the investment in Level 5.
