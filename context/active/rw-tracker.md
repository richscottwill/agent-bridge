...
- **Asana bridge**: see hands.md → Asana Bridge
- **Accountability**: aMCC tracks the hard thing + streak. Nervous system tracks patterns. Hands.md is the canonical task tracker.
...
- [ ] Update Kingpin Goals with Jan-Mar data — blocked by Andes
- [ ] Write AI Max test design — 4d overdue
- [ ] Reduce invoice/PO time to <30 min/week
- [x] Build automation tools — prediction engine, data layer, callout pipeline, attention tracker (3/28-3/30)
- [x] Baloo keyword data delivered (3/30)
- [x] W13 callouts produced for all 10 markets (3/30)
