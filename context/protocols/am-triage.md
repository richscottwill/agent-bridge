...
## EOD Summary Addendum

The EOD summary (generated by `session-summary.kiro.hook` or on request) must additionally include:
- **Metrics delta table** — Mon | Tue | Δ for streak, hard thing, Asana completions, MX pacing, any shifted project state
- **Five Levels scorecard** — L1 / L2 / L3 / L4 / L5 with evidence for whether today's work advanced each
- **Friction detected** — at least one, with proposed structural fix
- **One proposed system improvement** if friction was detected (structural, subtraction-before-addition check included)
