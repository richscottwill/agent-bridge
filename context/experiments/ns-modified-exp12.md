<!-- DOC-0157 | duck_id: experiment-ns-modified-exp12 -->
...
|--------|-------|--------|--------|
| Total body words | ~19,500w | ≤30,000w (safety limit) | ✅ Under limit |
| Organs over budget | N/A — budgets are adaptive | — | Priors at Beta(1,1) — no data yet |
